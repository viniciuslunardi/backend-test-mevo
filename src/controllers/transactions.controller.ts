...
export default class TransactionController {
    ...
    public async processTransactions(req: Request, res: Response): Promise<any> {
        try {
        ...
        const processedData = await this.transactionService.processTransaction(req.file.buffer);
